...
import pt.isel.gomoku.GomokuTestApplication
...
class PreserveDefaultDependencies<A : ComponentActivity>(
    ...
    val testApplication: GomokuTestApplication =
        ApplicationProvider.getApplicationContext() as GomokuTestApplication
